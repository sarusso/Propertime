...
class TestUtils(unittest.TestCase):
    ...
    def test_s_from_dt_naive(self):
        ...
        # Create a naive timestamp without the time zone and test conversion to epoch assumed on UTC
        date_time = datetime.datetime.strptime('2007-12-10', '%Y-%m-%d')
        self.assertEqual(s_from_dt(date_time),1197244800)
        
        # Now set the time zone and test to get to the same epoch
    ...
    def test_str_conversions(self):
        ...
        self.assertEqual(str_from_dt(dt(1986,8,1,16,46, tzinfo='UTC')), '1986-08-01T16:46:00+00:00')

        # To ISO on Europe/Rome, without DST, offset is +1. 
        self.assertEqual(str_from_dt(dt(1986,12,1,16,46, tzinfo='Europe/Rome')), '1986-12-01T16:46:00+01:00')

        # To ISO on Europe/Rome, with DST, offset is +2.        
        self.assertEqual(str_from_dt(dt(1986,8,1,16,46, tzinfo='Europe/Rome')), '1986-08-01T16:46:00+02:00')
